...
const projects = [
...

  {
    ...
    image: blog,
    source_code_link:
      "https://github.com/badiniibrahim/blog-app-next.js-13-tailwindCSS-mongodb",
  },
  {
  ...
  },
  {
    name: "SnapEvent",
    description:
      "Whether you're planning a business meeting, a memorable wedding, or a simple evening with friends, SnapEvent is your all-in-one solution to simplify your event management.",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
    ...
    image: snapevent,
    source_code_link:
      "https://github.com/badiniibrahim/snapevent-nextjs-stripe-mongodb-clerk",
  },
  {
    name: "NextLink App",
    description:
    ...
    image: next,
    source_code_link:
      "https://github.com/badiniibrahim/nexlink-app-with-next.js-13",
  },
  {
    name: "Car catalogue",
    description:
    ...
    image: car,
    source_code_link:
      "https://github.com/badiniibrahim/car-catalogue-next.js-13-tailwindCSS",
  },
  {
    name: "Nike landing page clone",
    description: "This template is a clone Nike website with Tailwind CSS",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
    ...
    image: nike,
    source_code_link:
      "https://github.com/badiniibrahim/nike_landing_page_clone",
  },
  {
    name: "Cinema Catalog",
    description:
    ...
    image: cine,
    source_code_link:
      "https://github.com/badiniibrahim/flutter-app-CinemaCatalog",
  },
  {
    name: "CoinView",
    description:
  ...
  },
  {
    ...
    image: cry,
    source_code_link:
      "https://github.com/badiniibrahim/flutter-app-crypto-dash",
  },
  {
    name: "Loctore mobile",
    description:
    ...
    image: mob,
    source_code_link:
      "https://play.google.com/store/apps/details?id=com.loctore.patient.loctore",
  },
  {
    ...
    image: shoulders,
    source_code_link:
      "https://github.com/badiniibrahim/flutter-fitness-gym-app",
  },
  {
    name: "Anime Hub",
    description:
      "Discover an endless world of anime with AnimeHub, your ultimate companion for exploring and enjoying a huge collection of the best anime. Immerse yourself in the captivating world of Japanese animation, where adventure, action, romance and fantasy meet ",
    tags: [
      {
        name: "flutter",
        color: "blue-text-gradient",
    ...
    image: anime,
    source_code_link:
      "https://play.google.com/store/apps/details?id=com.badini.animehub",
  },
  {
    name: "Fitfolio",
    description:
      "FitFolio is your ultimate companion to achieve your fitness goals",
    tags: [
      {
        name: "flutter",
        color: "blue-text-gradient",
    ...
    image: fitfolio,
    source_code_link:
      "https://play.google.com/store/apps/details?id=com.badini.fitfolio&hl=fr",
  },
];
